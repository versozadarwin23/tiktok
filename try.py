...
def create_fbunconfirmed(account_type, usern, gender, password=None, session=None):
    global custom_password_base, new_email
    ...
    print(f"\033[1;92m✅ | info | {full_name}\033[0m")
    try:
        print(f"\033[1;92m✅ | info | {new_email}\033[0m")
    except:
        try:
            print(f"\033[1;92m✅ | Email | {email_or_phone}\033[0m")
        except:
            pass
