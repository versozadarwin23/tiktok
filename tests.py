    ...
    try:
        ...
        if latest_version != __version__:
            ...
            try:
                ...
                # Verify downloaded file has the expected version to prevent infinite update loop
                if latest_version not in update_response.text:
                    print("❌ Downloaded file version mismatch. Aborting update to prevent loop.")
                ...
                print("✅ Update downloaded successfully! Please restart the script manually.")
                input("Press Enter to exit...")
                sys.exit(0)
